    ...
    <main className={style(["sections"])}>
      <section>
        ...
        <div className={style(["content", "about"])}>
          ...
          <div className={style(["text"])}>
            ...
            <p>
              Founded by tailor <span>Mandrix the Great</span> in the 1500s,
              Mandrips quickly became renowned for its commitment to superior
              quality and attention to fit. Its exceptional craftsmanship and
              innovative designs attracted the attention of the nobility,
              establishing Mandrips as a prestigious clothing brand. As time
              passed, Mandrips adapted and evolved with changing fashion trends
              and customer preferences while staying true to its core values of
              exceptional craftsmanship.
            </p>
            <p>
              Mandrips' legacy as a symbol of elegance and creativity in the
              fashion industry is a testament to its long-standing tradition of
              excellence. The brand's ability to adapt and evolve while
              maintaining its core values has contributed to its enduring
              success and popularity among fashion enthusiasts. Today, Mandrips
              stands as a respected and sought-after clothing brand,
              representing the epitome of elegance and creativity in the fashion
              world.
            </p>
          </div>
        </div>
      ...
      <section>
        ...
        <div className={style(["content", "who"])}>
          <h3>Who Are We</h3>
          <p>
            We are the decendants of Mandrips the great and have just started an
            online store to compete in the online marketplace. Our products has
            been the top of the line in quality since the 1500s and will
            continue to provide our customers with the same quality.
          </p>
          <div
            style={{
              display: "flex",
