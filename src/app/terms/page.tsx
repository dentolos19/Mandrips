  ...
  return (
    <main>
      ...
      <div className={useStyles(["text"])}>
        ...
        <p>Welcome to Mandrips!</p>

        <p>
          These terms and conditions outline the rules and regulations for the use of Mandrips's Website, located at
          mandrips.vercel.app.
        </p>

        <p>
          By accessing this website we assume you accept these terms and conditions. Do not continue to use Mandrips if
        ...
        <p>
          We employ the use of cookies. By accessing Mandrips, you agreed to use cookies in agreement with the
          Mandrips's Privacy Policy.{" "}
        </p>
        ...
        <p>
          Unless otherwise stated, Mandrips and/or its licensors own the intellectual property rights for all material
          on Mandrips. All intellectual property rights are reserved. You may access this from Mandrips for your own
          personal use subjected to restrictions set in these terms and conditions.
        </p>

        <p>You must not:</p>
        <ul>
          <li>Republish material from Mandrips</li>
          <li>Sell, rent or sub-license material from Mandrips</li>
          <li>Reproduce, duplicate or copy material from Mandrips</li>
          <li>Redistribute content from Mandrips</li>
        </ul>
        ...
        <p>
          ...
          areas of the website. Mandrips does not filter, edit, publish or review Comments prior to their presence on
          the website. Comments do not reflect the views and opinions of Mandrips,its agents and/or affiliates. Comments
          reflect the views and opinions of the person who post their views and opinions. To the extent permitted by
          applicable laws, Mandrips shall not be liable for the Comments or for any liability, damages or expenses
          caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this
          website.
        </p>

        <p>
          Mandrips reserves the right to monitor all Comments and to remove any Comments which can be considered
        ...
        <p>
          You hereby grant Mandrips a non-exclusive license to use, reproduce, edit and authorize others to use,
        ...
        <p>
          ...
          Mandrips; and (d) the link is in the context of general resource information.
        </p>
        ...
        <p>
          ...
          you must inform us by sending an e-mail to Mandrips. Please include your name, your organization name, contact
        ...
        <p>
          No use of Mandrips's logo or other artwork will be allowed for linking absent a trademark license agreement.
        </p>
